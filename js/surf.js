...
function LIGHTOFFsetFooterPos() {
  if (document.getElementById("footerCont")) {
    ...
    $("#LIGHTOFFfooterCont").css("display","none");
    $("#LIGHTOFFfooter").css("display","none");
  }
}

function LIGHTOFFhideImages() {
...
window.addEventListener("load", function() {
  ...
  setTimeout("LIGHTOFFhideImages()", 1500);
